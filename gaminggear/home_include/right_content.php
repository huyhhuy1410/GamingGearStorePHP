					...
					<div class="center1">
						...
						<?php if(isset( $_SESSION['username'])){
							?>
								...
								<span id="logout"><p><a href="logout.php">Đăng xuất</a></p></span>
						</div><!-- End .dangnhap-in-->
							<?php 
						}
						else{
...
?> <?php  echo number_format($tongtien,"0",",",".");?> VNĐ
				...
				<div id="fb-root">
					<div class="center1">
						...
						<div class="fb-like-box" data-href="https://www.facebook.com/HuyVy-Store-106049235277334" data-width="188" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="false"></div>
					</div><!-- End .center1 -->
				</div><!-- End .facebook -->