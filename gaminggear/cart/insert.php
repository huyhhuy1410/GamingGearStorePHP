...
$sql="INSERT INTO hoadon(idnd,hoten,diachi,dienthoai,email,ngaydathang, phuongthucthanhtoan,trangthai) VALUES 
('$idnd','$hoten', '$diachi', '$dienthoai', '$email', '$phuongthuc', '$ngay','1')";

}
	else 
	$sql="INSERT INTO hoadon(hoten,diachi,dienthoai,email,ngaydathang,phuongthucthanhtoan,trangthai) VALUES 
('$hoten', '$diachi', '$dienthoai', '$email', '$phuongthuc '$ngay','1')";
