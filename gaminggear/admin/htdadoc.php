...
$select = "select * from hotro where trangthai=1 ";
...
<div class="quanlysp">
	...
	<p>
	<a href='admin.php?admin=hienthiht'><input style="width:200px; margin-left:5px;" type="submit" name="giaohang" value="YÊU CẦU CHƯA XỬ LÝ" /></a>
	</p>
</div>
	...
	<form action="admin.php?admin=xulyht" method="post">
		<div id="check">
			<p>
				<input type="submit" name="huy" value="Chưa xử lý" />
