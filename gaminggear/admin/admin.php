...
<head>
	...
	<title> Chuyên các sản phẩm công nghệ </title>
...
<body style="background:url(../img/theme.jpg);">
	<div id="wapper">
		<div id="header">
			<div id="lg-header">
		...
		<div id="content">
			<div id="top-content">
				<p>Chào bạn <font color="red"><b><u><?= $_SESSION['username'] ?></u></b></font><a href="logout.php"> | Thoát</a></p>
			</div>
			<div id="main-content">
				<div id="left-content">
					<div class="danhmucsp">
						<div class="center">
							...
							<ul>
								...
								<li style="height:30px;"><a href="?admin=hienthibc"> Thống kê hàng hoá bán ra</a></li>
								<li style="height:30px;"><a href="?admin=hienthikho"> Thống kê số lượng tồn kho</a></li>
							</ul>
						</div><!-- End .center -->
					</div> <!-- End .menu-left -->
