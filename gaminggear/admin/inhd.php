                        ...
                        <tr>
                          <td>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tbody>
                                <tr>
                                  <td colspan="2"><strong>CỬA HÀNG ĐỒ CÔNG NGHỆ HUYVY STORE</strong></td>
                                </tr>
                                <tr>
                                  <td>Địa chỉ</td>
                                  <td>: Điện Biên Phủ, Phường 1, Quận 3, TP. HCM</td>
                                </tr>
                                <tr>
                                  <td width="65">Tel:</td>
                                  <td>: 0918467885</td>
        ...
        <td height="54">
          ...
          <table width="100%">
            ...
            <tr>
              ...
              <td>Ngày đặt hàng:</td>
<?php
$date1 = $row1['ngaydathang'];
$myDateTime = DateTime::createFromFormat('Y-m-d', $date1);
$formattedweddingdate = $myDateTime->format('d/m/Y');?>
            ...
            <tr>
              ...
              <td><?php echo date('d/m/Y', strtotime($date1. ' + 3 days')); ?></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><span class="style3">Phương thức thanh toán:</span></td>
              <td><?php if ($row1['phuongthucthanhtoan'] == 1) echo "Qua bưu điện";
                  else if ($row1['phuongthucthanhtoan'] == 2) echo "Qua thẻ ATM";
