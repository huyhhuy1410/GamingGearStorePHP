...
$select = "select * from hoadon where trangthai=3";
$query = mysqli_query($link, $select);
$dem = mysqli_num_rows($query);
?>
<div class="quanlysp">
	<h3>QUẢN LÝ HÓA ĐƠN ĐÃ HUỶ</h3>
	<div id="check" style = "position:relative; left:-365px; top:50px;">
	<p>
	<a href='admin.php?admin=ttdagiao'><input style="width:200px; margin-left:5px;" type="submit" name="giaohang" value="ĐƠN HÀNG ĐÃ GIAO" /></a>
	<a href='admin.php?admin=hienthihd'><input style="width:200px;" type="submit" name="giaohang" value="ĐƠN HÀNG CHƯA XỬ LÝ" /></a><br>
	</p>
</div>
...
<table>
	...
	$sql = mysqli_query($link, "SELECT * FROM hoadon where trangthai=3 ORDER by mahd DESC  LIMIT $from, $max_results");
	...
	else echo "<tr><td colspan='9'>Không có hoá đơn mới</td></tr>";
