...
$select = "select * from hoadon where trangthai=2";
$query = mysqli_query($link, $select);
$dem = mysqli_num_rows($query);
?>
<div class="quanlysp">
	<h3>QUẢN LÝ HÓA ĐƠN ĐÃ GIAO</h3>
	<div id="check" style = "position:relative; left:-365px; top:50px;">
	<p>
	<a href='admin.php?admin=ttdahuy'><input style="width:200px; margin-left:5px;" type="submit" name="giaohang" value="ĐƠN HÀNG ĐÃ HUỶ" /></a>
...
<table>
	...
	$sql = mysqli_query($link, "SELECT * FROM hoadon where trangthai=2 ORDER by mahd DESC  LIMIT $from, $max_results");
