...
$select = "select * from hoadon where trangthai=1";
...
<div class="quanlysp">
	...
	<a href='admin.php?admin=ttdagiao'><input style="width:200px;" type="submit" name="giaohang" value="ĐƠN HÀNG ĐÃ GIAO" /></a><br>
	</p>
</div>
...
<table>
	...
	$sql = mysqli_query($link, "SELECT * FROM hoadon where trangthai=1 ORDER by mahd DESC  LIMIT $from, $max_results");
